...
class Schedule extends React.Component {
  ...
  onChange = event => {
    if (event.target.name === "new_doctor") {
      ...
      this.setState({
        new_doctor_id: event.target.options[selectedIndex].getAttribute(
          "data-key"
        ),
  ...
  changeVisitsInfo = e => {
    e.preventDefault();
    if (
      this.state.note !== this.state.opened_visit.note ||
  ...
  onVisitClick = e => {
    ...
    this.setState({
      ...
      client_id: e.appointmentData.client_id,
      client_visits: []
    });
    axios({
      method: "get",
        ...
        <div className="col-md-11">
          ...
          >
            <div className="css_third_width p-3">
              ...
              <Form onSubmit={e => this.addVisit(e, new_client, new_client_id)}>
                <If condition={client !== ""}>
                  <div className="modal-header">
                    <button className='btn btn-outline-primary w-100' onClick={e => this.addVisit(e, client, client_id)}>
                      <FontAwesomeIcon className='fa-lg mr-1' icon={faPlusCircle} />
                      {client}
                    </button>
                  </div>
                </If>
                <div className="font-weight-bold">Новий прийом</div>
                <div className="css_full_width text-right">
                  Час прийому: {this.getVisitsTime(this.state.new_start)}
                </div>
                ...
                <label className="css_full_width">
                  Нотатка:
                  <Textarea
                    className="css_full_width form-control"
                ...
                <Button className="float-sm-right btn btn-outline-primary mb-3">
                  Підтвердити
                </Button>
              </Form>
            </div>
            ...
            <div className="css_third_width p-3">
              ...
              <Form onSubmit={this.changeVisitsInfo}>
                <div className="font-weight-bold">
                  Клієнт: {this.state.client}
                </div>
                <div className="css_full_width text-right">
                  Час прийому: {this.getVisitsTime(this.state.start)}
                </div>
                <label className="css_full_width">
                  Нотатка:
                  <Textarea
                ...
                <hr />
                <Button
                  className="float-sm-left btn btn-outline-primary my-3"
                  onClick={this.changeVisitsInfo}
                >
                  Підтвердити
                </Button>
              </Form>
